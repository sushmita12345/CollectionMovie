...
const movies = {
  Horror: [
    ...
    { name: "Annabelle", genres: "Horror", director: "David F. Sandberg", rating: 4.6 },
    {
      name: "Don't knock twice",
      genres: "Horror",
      director: "Caradog W. James", rating: 4.2
    }
  ],
  Thriller: [
    {
      ...
      genres: "Suspense",
      director: "Mayank Sharma", rating: 4.7
    },
    {
      name: "The Widow",
      genres: "Suspense",
    ...
    { name: "Kruthi", genres: "Suspense", director: "Manu Warrier", rating: 4.1 }
  ],
  Adventures: [
    {
      name: "The Lord of Rings",
      genres: "mystery",
      director: "Peter Jackson", rating: 4.0
    },
    {
      name: "Wheel Of Time",
      genres: "mystery",
      director: "Rosamund Pike, Daniel Henney, Josha Stradowski", rating: 4.3
    },
    { name: "Harry Potter", genres: "mystery", director: "Chris Colombus", rating: 4.5 }
  ],
  Action: [
    { name: "The Wall", genres: "Action", director: "Doug Liman", rating: 4.8 },
    { name: "Sherlock Holmes", genres: "Action", director: "Guy Ritchie", rating: 4.7 },
    { name: "Commando", genres: "Action", director: "Deven Bhojani", rating: 4.2 }
  ]
};
